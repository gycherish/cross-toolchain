target("binutils-env")
    ...
    on_build(function (target) 
        ...
        local package_info = package_env:get("toolchain.source.binutils")
        target:set("toolchain.binutils.source_dir", path.join(toolchain_env:get("toolchain.source_dir"), package_info.dirname))
        target:set("toolchain.native.binutils.build_dir", path.join(toolchain_env:get("toolchain.native.build_dir"), package_info.dirname))
        target:set("toolchain.native.binutils.ld", path.join(toolchain_env:get("toolchain.native.prefix"), "bin", "ld"))
        target:set("toolchain.cross.binutils.build_dir", path.join(toolchain_env:get("toolchain.cross.build_dir"), package_info.dirname))
        ...
        target:set("toolchain.cross.binutils.gdb.host.build_dir", path.join(toolchain_env:get("toolchain.cross.build_dir"), package_info.dirname .. "-gdb-host"))
        ...
        target:set("toolchain.cross.binutils.gdb.target.build_dir", path.join(toolchain_env:get("toolchain.cross.build_dir"), package_info.dirname .. "-gdb-target"))
        ...
        target:set("toolchain.cross_native.binutils.build_dir", path.join(toolchain_env:get("toolchain.cross_native.build_dir"), package_info.dirname))
        ...
        if option.get("verbose") then
            print("toolchain.source.binutils.: ", package_info)
...
target("binutils-download")
    ...
    on_build(function (target)
        ...
        local toolchain_env = project.target("toolchain-env")
        local package_env = project.target("toolchain-package-env")
        package.download(package_env:get("toolchain.source.binutils"), toolchain_env:get("toolchain.source_dir"))
        package.patch(package_env:get("toolchain.source.binutils"), toolchain_env:get("toolchain.source_dir"))
    end)
