target("mingw-env")
    ...
    on_build(function (target) 
        ...
        target:set("toolchain.mingw.url", "https://github.com/mingw-w64/mingw-w64.git")
        target:set("toolchain.mingw.branch", "v12.x")
        target:set("toolchain.mingw.source_dir", path.join(toolchain_env:get("toolchain.source_dir"), "mingw-12"))
        ...
        target:set("toolchain.cross.mingw.build_dir", path.join(toolchain_env:get("toolchain.cross.build_dir"), "mingws-12"))
        ...
        target:set("toolchain.cross_native.mingw.build_dir", path.join(toolchain_env:get("toolchain.cross_native.build_dir"), "mingws-12"))
        ...
        if option.get("verbose") then
            print("toolchain.mingw.url: ", target:get("toolchain.mingw.url"))
            print("toolchain.mingw.branch: ", target:get("toolchain.mingw.branch"))
...
target("mingw-download")
    ...
    on_build(function (target)
        ...
        if os.exists(mingw_env:get("toolchain.mingw.source_dir")) then
            print("mingw libc source code has already existed: ", mingw_env:get("toolchain.mingw.source_dir"))
            return
        end
        git.clone(mingw_env:get("toolchain.mingw.url"), {
            depth = 1, 
            branch = mingw_env:get("toolchain.mingw.branch"), 
            outputdir = mingw_env:get("toolchain.mingw.source_dir")
        })
    end)
